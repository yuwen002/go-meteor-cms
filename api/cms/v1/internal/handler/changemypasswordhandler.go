...
func changeMyPasswordHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := logic.NewChangeMyPasswordLogic(r.Context(), svcCtx)
		resp, err := l.ChangeMyPassword(&req)
		if err != nil {
