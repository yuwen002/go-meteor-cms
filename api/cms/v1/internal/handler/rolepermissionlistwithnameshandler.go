...
func rolePermissionListWithNamesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := logic.NewRolePermissionListWithNamesLogic(r.Context(), svcCtx)
		resp, err := l.RolePermissionListWithNames(&req)
		if err != nil {
