...
const (
	// Label holds the string label denoting the adminroledept type in the database.
	Label = "admin_role_dept"
	...
	FieldDeptID = "dept_id"
	// Table holds the table name of the adminroledept in the database.
	Table = "admin_role_depts"
)

// Columns holds all SQL columns for adminroledept fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
