...
type AdminUserQuery struct {
	...
	withUserRoles  *AdminUserRoleQuery
...
func (_q *AdminUserQuery) QueryRoles() *AdminRoleQuery {
...
func (_q *AdminUserQuery) QueryUserRoles() *AdminUserRoleQuery {
	query := (&AdminUserRoleClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *AdminUserQuery) WithRoles(opts ...func(*AdminRoleQuery)) *AdminUserQuery {
	query := (&AdminRoleClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *AdminUserQuery) WithUserRoles(opts ...func(*AdminUserRoleQuery)) *AdminUserQuery {
	query := (&AdminUserRoleClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *AdminUserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*AdminUser, error) {
	...
	if query := _q.withRoles; query != nil {
		if err := _q.loadRoles(ctx, query, nodes,
			func(n *AdminUser) { n.Edges.Roles = []*AdminRole{} },
			func(n *AdminUser, e *AdminRole) { n.Edges.Roles = append(n.Edges.Roles, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withUserRoles; query != nil {
		if err := _q.loadUserRoles(ctx, query, nodes,
			func(n *AdminUser) { n.Edges.UserRoles = []*AdminUserRole{} },
			func(n *AdminUser, e *AdminUserRole) { n.Edges.UserRoles = append(n.Edges.UserRoles, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *AdminUserQuery) loadRoles(ctx context.Context, query *AdminRoleQuery, nodes []*AdminUser, init func(*AdminUser), assign func(*AdminUser, *AdminRole)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[int64]*AdminUser)
	nids := make(map[int64]map[*AdminUser]struct{})
	...
	query.Where(func(s *sql.Selector) {
		...
		s.Join(joinT).On(s.C(adminrole.FieldID), joinT.C(adminuser.RolesPrimaryKey[1]))
...
func (_q *AdminUserQuery) loadUserRoles(ctx context.Context, query *AdminUserRoleQuery, nodes []*AdminUser, init func(*AdminUser), assign func(*AdminUser, *AdminUserRole)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(adminuserrole.FieldUserID)
	}
	query.Where(predicate.AdminUserRole(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(adminuser.UserRolesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
